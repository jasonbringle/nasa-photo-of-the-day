...
function App() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.nasa.gov/planetary/apod?api_key=gYyisI1LHqwbW7zSloS0gQx7F0RTEEACvdQIbem3&date=${year}-${month}-${day}`
      )
      .then(response => {
  ...
  return (
    ...
    <AppDiv>
      ...
      <ImageAndDesc>
        <Image picData={picData} />
        <Description picData={picData} />
      </ImageAndDesc>
